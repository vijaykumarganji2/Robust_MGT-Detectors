...
src_data_dir = './data/RODAM_Data/medquad_setup/train_valid_source_test_target/source_data'
tgt_data_dir = './data/RODAM_Data/medquad_setup/train_valid_source_test_target/target_data'
...
model_save_name = f'rodam_train_valid_source_test_target_medquad.pt'
checkpoint_name = f'checkpoint_rodam_train_valid_source_test_target_medquad.pt'
